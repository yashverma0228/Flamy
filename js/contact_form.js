...
function Flamy_Contact_Form() {
    ...
    // Contact Form
    if (jQuery('.Flamy-contact-form:not(.is-init)').length) {
        jQuery('.Flamy-contact-form:not(.is-init)').each(function () {
            let $form = jQuery(this),
                $response = $form.find('.Flamy-contact-form__response'),
                formData;
            ...
            $form.on('submit', function (e) {
                ...
                jQuery.ajax({
                    ...
                    .done(function (response) {
                        ...
                        $response.empty().removeClass('Flamy-alert-danger').addClass('Flamy-alert-success').slideDown(200);
                    ...
                    .fail(function (data) {
                        $form.removeClass('is-busy');
                        $response.empty().removeClass('Flamy-alert-success').addClass('Flamy-alert-danger').slideDown(200);
